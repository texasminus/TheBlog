createUserButton.addEventListener("click",function(){
    ...
    ajax.open("POST", "https://cse.taylor.edu/~cos143/users.php");
...
logoutButton.addEventListener("click", function(){
	...
	ajax.open("delete", "https://cse.taylor.edu/~cos143/sessions.php");
	ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded")
	ajax.send();
})
...
loginButton.addEventListener("click",function(){
	...
	ajax.open("POST", "https://cse.taylor.edu/~cos143/sessions.php");
	ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded")
	ajax.send(params);
})
...
changePasswordButton.addEventListener("click", function(){
	...
	ajax.open("PUT","https://cse.taylor.edu/~cos143/users.php")
	ajax.setRequestHeader("Content-type","application/x-www-form-urlencoded")
	ajax.send(params);
})